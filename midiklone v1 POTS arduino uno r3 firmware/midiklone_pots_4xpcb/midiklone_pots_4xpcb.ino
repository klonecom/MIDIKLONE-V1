...
///midiklone v1 - 64 x potentiometers************klonecom-electronics******///
...
Pot MPO49(M4, 0, 0, 110, 1);
Pot MPO50(M4, 1, 0, 21, 1);
Pot MPO51(M4, 2, 0, 22, 1);
Pot MPO52(M4, 3, 0, 115, 1);
Pot MPO53(M4, 4, 0, 24, 1);
Pot MPO54(M4, 5, 0, 25, 1);
Pot MPO55(M4, 6, 0, 117, 1);
Pot MPO56(M4, 7, 0, 103, 1);
Pot MPO57(M4, 8, 0, 28, 1);
Pot MPO58(M4, 9, 0, 29, 1);
Pot MPO59(M4, 10, 0, 30, 1);
Pot MPO60(M4, 11, 0, 112, 1);
Pot MPO61(M4, 12, 0, 118, 1);
Pot MPO62(M4, 13, 0, 86, 1);
Pot MPO63(M4, 14, 0, 87, 1);
Pot MPO64(M4, 15, 0, 88, 1);

Pot *MUXPOTS[] {&MPO1, &MPO2, &MPO3, &MPO4, &MPO5, &MPO6, &MPO7, &MPO8, &MPO9, &MPO10, &MPO11, &MPO12, &MPO13, &MPO14, &MPO15, &MPO16, &MPO17, &MPO18, &MPO19, &MPO20, &MPO21, &MPO22, &MPO23, &MPO24, &MPO25, &MPO26, &MPO27, &MPO28, &MPO29, &MPO30, &MPO31, &MPO32, &MPO33, &MPO34, &MPO35, &MPO36, &MPO37, &MPO38, &MPO39, &MPO40, &MPO41, &MPO42, &MPO43, &MPO44, &MPO45, &MPO46, &MPO47, &MPO48, &MPO49, &MPO50, &MPO51, &MPO52, &MPO53, &MPO54, &MPO55, &MPO56, &MPO57, &MPO58, &MPO59, &MPO60, &MPO61, &MPO62, &MPO63, &MPO64, };
